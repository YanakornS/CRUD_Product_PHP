...
<head>
    ...
    <style>
      body {
    background: linear-gradient(135deg, #D9EAFD, #A8D8FF); /* ไล่สีจาก #D9EAFD ไปยัง #A8D8FF */
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <select id="features" name="features" class="form-select" required>
                    ...
                    <option value="Size xl" <?php echo $product['features'] == 'Size Xl' ? 'selected' : ''; ?>>Size xl</option>
                    ...
                    <option value="Light weight" <?php echo $product['features'] == 'Light weight' ? 'selected' : ''; ?>>Light weight</option>
                </select>
            </div>
