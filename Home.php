...
.product-actions a {
    display: flex;
    align-items: center; /* จัดให้ไอคอนและข้อความอยู่ในแนวเดียวกัน */
    padding: 5px 15px; /* เพิ่มระยะห่างในปุ่ม */
    font-size: 14px; /* ขนาดข้อความในปุ่ม */
    transition: background-color 0.3s, transform 0.3s; /* เพิ่มเอฟเฟกต์เมื่อ hover */
}
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#">
                        <img src="https://cdn-icons-png.flaticon.com/512/9131/9131478.png" alt="Profile Image" class="profile-img me-2">
...
<div class="container mt-1">
    ...
    <a href="EditProduct.php?id=<?php echo $product['id']; ?>" class="btn btn-warning btn-sm edit-btn">
        <i class="fas fa-edit"></i> Edit
    </a>
    <a href="delete.php?id=<?php echo $product['id']; ?>" class="btn btn-danger btn-sm delete-btn">
