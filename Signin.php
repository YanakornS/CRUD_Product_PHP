...
<body class="d-flex justify-content-center align-items-center vh-100" style="background-color: #D9EAFD;">
    ...
    <div class="login-form w-100 px-4 py-5 rounded" style="max-width: 400px; background-color: #ffffff; box-shadow: 0 8px 15px rgba(0, 0, 0, 0.1);">
        ...
        <p class="mt-4 text-center">Don't have an account? <a href="Signup.php" class="text-primary fw-bold text-decoration-none">Register here</a></p>
    </div>
